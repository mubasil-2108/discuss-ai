...
export const LoadingIconButton = ({ setInput, loading, }) => {

    return (
        <Tooltip title="Enter something first">
            <IconButton disabled={loading} type='submit' sx={{ ":hover": { background: '#252525' }, opacity: loading ? 0.5 : 1 }}>
...
export const GradientButton = ({startNewSession}) => {
  return (
    <StyledWrapper>
      <div className="sp" >
        <button onClick={startNewSession} className="sparkle-button">
...
export const AnimatedButton = ({startNewSession}) => {
  return (
    <AnimatedButtonWrapper>
      <Button startIcon={<ChatIcon/>} className='button' onClick={startNewSession} sx={{cursor: 'pointer', gap:1}}> Discuss Ai.
      </Button>
    </AnimatedButtonWrapper>
  );
}
